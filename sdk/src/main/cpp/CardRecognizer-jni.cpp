...
extern "C" {
    ...
    Java_com_yagna_cardscanner_sdk_ndk_RecognitionCoreNdk_nativeSetDataPath(JNIEnv *env, jobject instance,
                                                                   jstring path_) {
        std::string stdPath;
    ...
    JNIEXPORT void JNICALL
    Java_com_yagna_cardscanner_sdk_ndk_RecognitionCoreNdk_nativeInit(JNIEnv *env, jclass type) {
    ...
    JNIEXPORT void JNICALL
    Java_com_yagna_cardscanner_sdk_ndk_RecognitionCoreNdk_nativeSetRecognitionMode(JNIEnv *env,
                                                                                      jobject instance,
    ...
    JNIEXPORT void JNICALL
    Java_com_yagna_cardscanner_sdk_ndk_RecognitionCoreNdk_nativeDeploy(JNIEnv *env,
                                                                       jobject instance) {
        g_core->Deploy();
    }

    JNIEXPORT void JNICALL
    Java_com_yagna_cardscanner_sdk_ndk_RecognitionCoreNdk_nativeSetOrientation(JNIEnv *env,
                                                                            jobject instance,
    ...
    JNIEXPORT void JNICALL
    Java_com_yagna_cardscanner_sdk_ndk_RecognitionCoreNdk_nativeCalcWorkingArea(JNIEnv *env,
                                                                         jobject instance,
                                                                         jint frameWidth,
                                                                         jint frameHeight,
    ...
    JNIEXPORT void JNICALL
    Java_com_yagna_cardscanner_sdk_ndk_RecognitionCoreNdk_nativeDestroy(JNIEnv *env, jclass type) {
        g_core = nullptr;
    }

    JNIEXPORT void JNICALL
    Java_com_yagna_cardscanner_sdk_ndk_RecognitionCoreNdk_nativeResetResult(JNIEnv *env,
                                                                         jobject instance) {
        g_core->ResetResult();
    }

    JNIEXPORT void JNICALL
    Java_com_yagna_cardscanner_sdk_ndk_RecognitionCoreNdk_nativeSetIdle(JNIEnv *env, jobject instance,
                                                                     jboolean idle) {
        g_core->SetIdle(idle);
    ...
    Java_com_yagna_cardscanner_sdk_ndk_RecognitionCoreNdk_nativeIsIdle(JNIEnv *env,
                                                                    jobject instance) {
        return (jboolean) g_core->IsIdle();
    }

    JNIEXPORT void JNICALL
    Java_com_yagna_cardscanner_sdk_ndk_RecognitionCoreNdk_nativeSetTorchStatus(JNIEnv *env,
                                                                            jobject instance,
                                                                            jboolean isTurnedOn) {
    ...
    Java_com_yagna_cardscanner_sdk_ndk_RecognitionCoreNdk_nativeProcessFrameYV12(JNIEnv *env,
                                                                              jobject instance,
                                                                              jint src_width,
                                                                              jint src_height,
                                                                              jint rotation,
